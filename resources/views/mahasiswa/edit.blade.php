                ...
                <form action="{{ route('mahasiswa.update', $mahasiswa->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama_lengkap" class="form-control"
                            value="{{ old('nama_lengkap', $mahasiswa->nama_lengkap) }}" placeholder="Masukkan Nama Lengkap"
                            required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="tgl_lahir" class="form-control"
                            value="{{ old('tgl_lahir', $mahasiswa->tgl_lahir) }}" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" name="email" class="form-control"
                            value="{{ old('email', $mahasiswa->email) }}" placeholder="Masukkan Email" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="alamat" rows="4" class="form-control" placeholder="Masukkan Alamat" required>{{ old('alamat', $mahasiswa->alamat) }}</textarea>
                    </div>

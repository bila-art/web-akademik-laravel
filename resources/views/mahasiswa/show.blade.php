                ...
                <form action="{{ route('mahasiswa.update', $mahasiswa->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama_lengkap" class="form-control"
                            value="{{ old('nama_lengkap', $mahasiswa->nama_lengkap) }}" placeholder="Masukkan Nama">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="prodi" class="form-select">
                            ...
                            <option value="MI" {{ old('prodi', $mahasiswa->prodi) == 'MI' ? 'selected' : '' }}>MI
                            </option>
                            <option value="TK" {{ old('prodi', $mahasiswa->prodi) == 'TK' ? 'selected' : '' }}>TK
                            </option>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="alamat" rows="4" class="form-control" placeholder="Masukkan Alamat">{{ old('alamat', $mahasiswa->alamat) }}</textarea>
                    </div>
